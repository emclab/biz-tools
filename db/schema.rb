...
ActiveRecord::Schema.define(:version => 20131016020708) do
  ...
  create_table "ruote_docs", :primary_key => "typ", :force => true do |t|
  ...
  add_index "ruote_docs", ["typ", "ide", "rev"], :name => "sqlite_autoindex_ruote_docs_1", :unique => true
  add_index "ruote_docs", ["wfid"], :name => "ruote_docs_wfid_index"
